...
def zeidel_method(
    ...
    """Naive implementation of Zeidel method to solve system of linear equations.
    ...
    Raises:
        ...
        ValueError: Raised when matrix A has not passed Zeidel convergence condition

    Returns:
        ColumnVector: Solution of SoLE
    """
    raise NotImplementedError("Zeidel method is not implemented yet")
